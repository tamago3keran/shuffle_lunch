...
module.exports = {
  entry: {
    ...
    user_matching_score_index: './src/javascripts/pages/users/matching_scores/matching_score_index.js',
    ...
    admin_user_index: './src/javascripts/pages/admin/users/user_index.js',
    admin_user_new: './src/javascripts/pages/admin/users/user_new.js',
  },
